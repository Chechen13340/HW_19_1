...
serverPort = 9090  # Порт для доступа по сети
    ...
    <div class="container">
        ...
        <main class="row">
            <div class="row text-center">
                ...
                <div class="mt-20" style="width: 38rem;">
                    <div class="card mb-10 rounded-7 shadow-sm">
                        <div class="card-body">
                                <form>
                                  <div class="mb-2">
                                  ...
                                  <button type="button" class="w-50 btn btn-success">Sent</button>
                                </form>
            </div>
                         ...
                         <h4 class="card-title">FAQ</h4>
                            ...
                            <div class="collapse" id="collapseExample">
                              <div class="card card-body">
                                You can sent our form and our manager call you.
                              </div>
                            </div>
                            <div class="collapse" id="collapseExample2">
                              <div class="card card-body">
                                PonyExpress, SDEK, Post office, EMS
                              </div>
                            </div>
                            <div class="collapse" id="collapseExample3">
                              <div class="card card-body">
                                You can pay for your order after get it.
                              </div>
                            </div>
    </div>
